	...
	<div class="dog-admin--box">
		...
		<div class="dog-admin--box-content">
			...
			<p class="dog-admin--controls">
				<input type="button" class="dog-admin--control button button-primary key-check" value="<?= __('Verifică actualizări disponibile') ?>" onclick="dog_admin__section_update(this, '<?= DOG_ADMIN__NONCE_UPDATE_CHECK ?>')">
				<input type="button" class="dog-admin--control button button-primary key-update dog-admin--hidden" value="<?= __('Doresc actualizarea') ?>" onclick="dog_admin__section_update(this, '<?= $section_name ?>')">
