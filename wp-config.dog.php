...
define('DOG_ADMIN__TRANSIENT_FORM_MESSAGE', 'dog__form_message');
define('DOG_ADMIN__TRANSIENT_FORM_ERROR', 'dog__form_error');
define('DOG_ADMIN__TRANSIENT_FORM_RESPONSE', 'dog__form_response');
define('DOG_ADMIN__TRANSIENT_EXPIRE_FORM_MESSAGE', 60 * 5);