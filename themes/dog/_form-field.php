...
$html = array(
	'errors' => dog__get_include_contents(dog__parent_file_path('_form-field-errors.php'), $form_field_data),
	'wrapper' => dog__get_include_contents(dog__parent_file_path('_form-field-wrapper.php'), $form_field_data),
	'label' => dog__get_include_contents(dog__parent_file_path('_form-field-label.php'), $form_field_data),
	'hint' => dog__get_include_contents(dog__parent_file_path('_form-field-hint.php'), $form_field_data)
);
...
$html['field'] = dog__get_include_contents(dog__parent_file_path('_form-field-' . $form_field_data['global']['tag'] . '.php'), $form_field_data);
